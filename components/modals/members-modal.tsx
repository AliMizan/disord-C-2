...
import { Check, Gavel, Loader, MoreVertical, Shield, ShieldCheck, ShieldQuestion } from "lucide-react";
                ...
                {server?.members?.map((member)=> (
                    <div key={member.id} className="flex items-center gap-x-2 mb-6" >
                        ...
                        <div className="flex flex-col gap-y-1 " >
                            <div className="text-xs font-semibold flex gap-x-1 items-center" >
                                {member.profile.name}
